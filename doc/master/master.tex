...
\begin{document}
  ...
  % chapter Grundlagen }}}
	...
	einem Standard-Algorithmus vergleicht.
		...
		Um den Median der Paket-Größen $q_{median}$ in der UDP-Receive-Queue bestimmen zu können, reicht
		...
		ist es möglich den Funktions-Aufruf des BIND abzufangen und die Paket-Größe zu ermitteln.
		...
		sich sagen, dass ab einer Paket-Größe von 64 Byte alle 128 Byte eine Erhöhung des
