...
\begin{document}
  ...
  % chapter Grundlagen }}}
	...
	Lastspitzen mit bis zu 5000 Anfragen pro Sekunde kam und der Root-Server ca. 93\% der Anfragen
	sofort beantworten konnte. Die restlichen 7\% waren Anfragen konnte nicht beantwortet werden, weil
	...
	eingingen und davon 85\% wiederholte Anfragen waren (selber Client und selbe Anfrage). Außerdem
	...
	\ref{rfc1034, rfc1035} zu sein oder falsch konfigurierte Softwaresysteme. Diese fehlerhaften
	DNS-Anfragen machen insgesamt ungefähr einen Anteil von 14\% aus. Außerdem werden Root-Server
	...
	In \cite{sapate2005} wird das Verhalten von Anycast-DNS-Servern Ende des Jahres 2004 untersucht. Dazu werden die
	...
	alle ihre Server. Die Messungen zeigen, dass bei den Root-Server nur 15\%-27\% der Anfragen an den
	geografisch nähsten Cluster geschickt gesendet werden. Im Vergleich dazu werden 45\% bis 53\% der
	...
	\label{cha:messungen}
		...
		% TODO: Kursiv
			...
			Allerdings liegt sie bei der ib6 für alle Faktoren mit salbnet immer nahe 100\%. Dies könnte
			...
			Anfragen von salbnet entsprechen für den Faktor 400 ca. 25\%, für 800 ca. 33\% und für 1600
			ca. 50\% der verlorenen Anfragen von wrr. Noch deutlicher werden die Unterschiede bei dem
			Vergleich der
			...
			So entspricht die Antwortzeit von salbnet nur ca. 15\% der von wrr und die Verbindungszeit im
			Durchschnitt nur ca. 30\%.
