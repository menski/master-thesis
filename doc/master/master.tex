...
\begin{document}
  ...
  % chapter Grundlagen }}}
	...
	Ausblick auf mögliche Verbesserungen und Weiterentwicklungen gegeben.
		...
		erweitern, dass es auch mit UDP-Verkehr funktioniert. Dazu wurde als Anwendungsfall der Betrieb
		eines DNS-Clusters gewählt, weil DNS-Verkehr hauptsächlich aus UDP-Anfragen besteht. Weiterhin hat
		das DNS durch seinen Aufbau als baumartige Struktur kritische Bereiche, in denen eine
		Lastverteilung dringend nötig ist. So werden vor allem bei DNS-Root-Servern und Nameservern von
		...
		Auslastung des Nameservers gefunden werden. Vor allem musste mit dieser Metrik eine
		Credit-Berechnung möglich sein. Dies war mit Abstand das größte Problem, da nicht jede
