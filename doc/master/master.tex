...
\begin{document}
  ...
  % chapter Grundlagen }}}
	...
	Allerdings gab es auch wie einen F-Root-Server in Los Angeles, USA, welcher \unit[88]{\%} seiner Anfragen
	aus Asien erhielt. Oder ein K-Root-Server nähe Delhi, Indien, welcher über \unit[75]{\%} seiner Anfragen
	aus Nordamerika, Südamerika und Europa erhielt. Hingegen waren die Anfragen vom K-Root-Server in
	Tokyo, Japan, zu \unit[99,7]{\%} aus Japan und \unit[75]{\%} waren von Clients mit einer Entfernung unter
	\unit[1000]{km}.
