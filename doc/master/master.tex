	...
	\label{cha:grundlagen}
		...
		Softwaresysteme eingegangen, welche aktuell zur Bereitstellung eines DNS-Servers genutzt werden.
			...
			\label{sub:software}
				...
				Das von Daniel J. Bernstein entwickelte Softwarepaket djbdns \cite{djbdns} ist einer der
				...
				Besonderheit von djbdns liegt darin, dass es ein Softwarepaket aus mehreren Programmen ist,
