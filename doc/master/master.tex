...
\begin{document}
	...
	\label{cha:einleitung}
		...
		Lastverteilung vorgestellt. Anschließend werden im Kapitel \ref{cha:salbnet} einige Arbeiten
...
$~$\\
	...
	\ref{cha:implementierung} beschrieben.
		...
		Wie in Kapitel \ref{cha:salbnet} beschrieben, ist salbnet ursprünglich nur für TCP-Anwendung
