...
\begin{document}
	...
	\label{cha:grundlagen}
		...
		Softwaresysteme eingegangen, welche aktuell zur Bereitstellung eines DNS-Servers genutzt werden.
			...
			für etwaige Subdomains verantwortlich sind.
				...
				Top-Level-Domains (TLDs)\footnote{\url{http://data.iana.org/TLD/tlds-alpha-by-domain.txt} (Stand:
			...
			\label{sub:software}
				...
				(BIND)\footnote{\url{http://www.isc.org/software/bind}} Server wurde am Anfang der achtziger Jahre
				...
				Der Name Server Daemon (NSD)\footnote{\url{http://www.nlnetlabs.nl/projects/nsd/}} wird von den
				...
				Der Microsoft DNS Server\footnote{\url{http://technet.microsoft.com/dns}} ist eine Implementation
				...
				djbdns\footnote{\url{http://cr.yp.to/djbdns.html}} ist einer der verbreitetsten DNS-Server. Daniel
				...
				Belohung\footnote{\url{http://cr.yp.to/djbdns/guarantee.html}} von \$1000 aus, für den ersten der
				...
				Das Programm dnsmasq\footnote{\url{http://www.thekelleys.org.uk/dnsmasq/doc.html}} wurde
		...
		Besonderheiten und existierende Verfahren der Lastverteilung von DNS-Verkehr erklärt werden.
			...
			perlbal\footnote{\url{http://github.com/perlbal}} oder das Apache-Modul
			mod\_proxy\_balancer\footnote{\url{http://httpd.apache.org/docs/2.2/mod/mod\_proxy\_balancer.html}}.
			...
			(LVS)\footnote{\url{http://www.linuxvirtualserver.org/}} \cite{zhang2000} für Linux und den
			Paketfilter pf\footnote{\url{http://www.benzedrine.cx/pf.html}} für OpenBSD als bekannteste
			...
			(A-M)\footnote{\url{http://www.root-servers.org}}. Von ihnen nutzen 9 (A, C, F, G, I, J, K, L und M)
  ...
  % chapter Grundlagen }}}
	...
	\label{cha:salbnet}
		...
		Dieses Kapitel beschreibt salbnet\footnote{\url{http://salbnet.org}}, einen Credit-basierten
		...
		\subsection*{libnethook} % {{{
			...
			Apache Webserver\footnote{\url{http://httpd.apache.org/}} (httpd) abgefangen und analysiert. In
...
$~$\\
	...
	einem Standard-Algorithmus vergleicht.
		...
		Kernel
		3.3\footnote{\url{http://git.kernel.org/?p=linux/kernel/git/torvalds/linux.git;a=commit;h=52b7c59b}}
	...
	\label{cha:messungen}
		...
		Benchmarks UnixBench\footnote{\url{http://code.google.com/p/byte-unixbench/}} bestimmt. Dieser
